...
devtools::install_url('https://github.com/catboost/catboost/releases/download/v0.26/catboost-R-Windows-0.26.tgz', INSTALL_opts = c("--no-multiarch", "--no-test-load"), quiet = TRUE, upgrade = FALSE)
